        ...
        <div class="row  align-items-center">
            <div class="col-lg-5">
                <div class="thumbnail m-img">
                    <img src="assets/images/italia/italiaregular.webp" alt="team-image" style="border-radius: 10px">
                </div>
                <br>
                <br>
                <br>
            ...
            <div class="col-lg-7">
                <div class="personal-info-team">
                    <div class="inner-content sal-animate" data-sal="slide-up" data-sal-delay="150" data-sal-duration="900">
                        ...
                        <p class="disc">
                            Italia Gyp Regular Plasterboards are produced from high purity natural gypsum core being sheeted in a closely adhering best selected paper liners. Italia Gyp Regular Plasterboard has fiber glass which improves strength and Sag Resistance. It is lightweight for use in standard internal wall and ceiling applications.
                        </p>
                    ...
                    <div class="inner-content sal-animate" data-sal="slide-up" data-sal-delay="150" data-sal-duration="900">
                        ...
                        <p class="disc">
                            Italia Gyp Regular Plasterboards are used in Residential Buildings, Commercial Buildings, Hospitals, Airports, Educational Institutions and other such applications.
                        </p>
                        <!-- ingle information start -->
                    ...
                    <div class="inner-content sal-animate" data-sal="slide-up" data-sal-delay="150" data-sal-duration="900">
                        ...
                        <p class="disc">
                            Italia Gyp Regular Plasterboards are produced to ASTM C1396/C1396M & EN 520 Type A standards.
                        </p>
                        <!-- ingle information start -->
        ...
        <div class="col-5 ">
            <div class="container ">
                <div class="row">
                    ...
                    <img class="text-center" src="assets/images/italia/r.webp" alt="">
                </div>
            </div>
...
<div class="container mt-5">
    <h3 class="title text-center">Product Characteristics</h3>
    <div class="row text-center">
        ...
        <div class="col-4 mt-3">
            ...
            <div id="icon-r">
                <img class="mb-3" src="assets/images/italia/r-rating.svg" alt="" srcset="" width="35%">
                <h6>Fire & Acoustic Rating</h6>
                <p>Italia Gypsum System application</p>
            </div>
        </div>
